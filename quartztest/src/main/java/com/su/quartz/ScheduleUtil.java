...
public class ScheduleUtil
{
      ...
      throws ServiceException
  {
    ...
    try
    {
      ...
      Class<? extends Job> jobClass = (Class<? extends Job>) Class
          .forName(scheduleJob.getClassName()).newInstance().getClass();
      ...
      logger.info("Create schedule job {}-{} success", scheduleJob.getJobGroup(),
      ...
      throws ServiceException
  {
    ...
    try
    {
      ...
      logger.info("Update schedule job {}-{} success", scheduleJob.getJobGroup(),
          scheduleJob.getJobName());
  ...
  public static void run(Scheduler scheduler, ScheduleJob scheduleJob) throws ServiceException
  {
    try
    {
      ...
      logger.info("Run schedule job {}-{} success", scheduleJob.getJobGroup(),
          scheduleJob.getJobName());
    }
    catch (SchedulerException e)
    {
  ...
  public static void pauseJob(Scheduler scheduler, ScheduleJob scheduleJob) throws ServiceException
  {
    try
    {
      ...
      logger.info("Pause schedule job {}-{} success", scheduleJob.getJobGroup(),
          scheduleJob.getJobName());
    }
    catch (SchedulerException e)
    {
  ...
  public static void resumeJob(Scheduler scheduler, ScheduleJob scheduleJob) throws ServiceException
  {
    try
    {
      ...
      logger.info("Resume schedule job {}-{} success", scheduleJob.getJobGroup(),
          scheduleJob.getJobName());
    }
    catch (SchedulerException e)
    {
  ...
  public static void deleteJob(Scheduler scheduler, ScheduleJob scheduleJob) throws ServiceException
  {
    try
    {
      ...
      logger.info("Delete schedule job {}-{} success", scheduleJob.getJobGroup(),
          scheduleJob.getJobName());
    }
    catch (SchedulerException e)
    {
  ...
  public static void validateCronExpression(ScheduleJob scheduleJob) throws ServiceException
  {
    if (!CronExpression.isValidExpression(scheduleJob.getCronExpression()))
    {
      throw new ServiceException(String
          .format("Job %s expression %s is not correct!", scheduleJob.getClassName(),
